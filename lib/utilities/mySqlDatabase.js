(function() {
  var Client, Eyes, MySql, client, connect, database, field, query, table, table2, tableA, tableC, tableO;
  ...
  module.exports = MySql = (function() {
    function MySql() {}
    MySql.prototype.getHeadersExpress = function(res, callback) {
    ...
    MySql.prototype.getHeaders = function(callback) {
      return connect(function() {
        var queryText;
        queryText = "SELECT DISTINCT " + field + " FROM " + table;
        return query(queryText, function(results) {
    ...
    MySql.prototype.getAll = function(callback) {
      return connect(function() {
        var queryText;
    ...
    MySql.prototype.getPackages = function(callback) {
      return connect(function() {
        var queryText;
